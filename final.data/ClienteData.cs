                        ...
                        if (lector != null && lector.HasRows)
                        {
                            ...
                            while (lector.Read())
                            {
                                cliente = new Cliente
                                {
                                    ...
                                    Apellidos = lector[2].ToString(),
                                    Direccion = lector[3].ToString(),
                                    Referencia = lector[4].ToString(),
                                    IdTipoCliente = int.Parse(lector[5].ToString()),
                                    IdTipoDocumento = int.Parse(lector[6].ToString()),
                                    NumeroDocumento = lector[7].ToString(),
                                    Estado = lector[8].ToString() == "1" ? true : false
                                };
